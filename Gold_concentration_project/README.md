...
5. Итоговое значение качества модели sMAPE на тестовой выборке составляет 9.29. При проверке модели на адекватность сделан вывод, что она показывает лучший результат, чем константная модель.
